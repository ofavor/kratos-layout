...
func RegisterGreeterHTTPServer(s *http.Server, srv GreeterHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/helloworld/greeter/{id}", _Greeter_SayHello0_HTTP_Handler(srv))
	r.POST("/v1/helloworld/greeter", _Greeter_Create0_HTTP_Handler(srv))
}
...
func _Greeter_Create0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationGreeterCreate)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *GreeterHTTPClientImpl) Create(ctx context.Context, in *CreateRequest, opts ...http.CallOption) (*CreateResponse, error) {
	...
	pattern := "/v1/helloworld/greeter"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationGreeterCreate))
